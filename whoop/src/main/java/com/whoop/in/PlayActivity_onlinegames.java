...
public class PlayActivity_onlinegames extends Activity
{	
	...
	String url="http://www.pocketad.in/webservices/index.php?tag=game_view&imei=";//911343705913699&game_code=YRVSO1GAZE2351
	...
	{	super.onCreate(savedInstanceState);
		...
		Play_1_name = bundle.getString("gamecodesent");
	 ...
	 // set encryption
	    ...
	    */
        ...
        mShaker = new ShakeListener(PlayActivity_onlinegames.this);
